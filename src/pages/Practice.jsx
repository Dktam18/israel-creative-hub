...
import { FaTelegramPlane, FaTimes, FaWhatsapp } from "react-icons/fa";
  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
    <div className="bg-white rounded-lg p-6 max-w-md w-full relative">
      ...
      <div className="text-center">
        ...
        <p className="mb-6">Get instant updates on JAMB news, exam tips, and more by joining our educational platforms.</p>
        ...
        <div className="flex flex-col gap-4">
          ...
          {/* Telegram Button */}
          <a
            href="https://t.me/icreativeh"  // replace with your actual Telegram channel link
            target="_blank"
            rel="noopener noreferrer"

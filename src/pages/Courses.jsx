        ...
        <div className='w-4/5 m-auto'>
          <div className='heading mb-16'>
            <h1 className='text-3xl font-semibold text-black'>
              Find The Right <br />
              lessons for each subjects
            </h1>
            <span className='text-sm mt-2 block'>you don't have to struggle alone, you've got our assistance and help with our well detailed and explanatory lesson notes.</span>
          </div>
                ...
                <div className='text p-3'>
                  <div className='flex justify-between items-center'>
                    <div className='flex items-center'>
                      <FaBook />
                      <span className='text-[14px] ml-2'> 1 lesson</span>
                    </div>
                    <div className='flex items-center'>
                  ...
                  <div className='user flex items-center'>
                    <img className='rounded-full w-8' src='https://i.postimg.cc/PqkFV6Sv/download-1-343.jpg' alt='Israel Mrakpor.png' />

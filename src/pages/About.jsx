        ...
        <div className="container">
          <div className="heading text-center py-12">
            <h1 className="text-3xl font-semibold text-black">
              Why "Israel Creatives" are Out Of The Ordinary
            </h1>
          ...
          <div className="grid grid-cols-4 gap-5 mt-30 md:grid-cols-1">
            <AboutCard
              ...
              desc="We've got materials, lesson notes and courses for all subjects. "
            />
            <AboutCard
              color="bg-[#DD246E]"
              icon={<FaChalkboardTeacher size={50} />}
              title="Expert tutors"
              desc="Our expert tutors are always available to guide you. "
            />
            <AboutCard
              color="bg-[#8007E6]"
              icon={<FaBrain size={50} />}
              title="Student community"
              desc="Our platform also helps to connect students and aid communal learning and implementation."
            />
            <AboutCard
              color="bg-[#0CAE74]"
              icon={<FaRegNewspaper size={50} />}
              title="Latest Educational news"
              desc="We keep you abreast and informed and aware of all educational news."
            />
          </div>
        </div>
      </section>
          ...
          <div className="heading w-4/5 md:w-full">
            ...
            <ul className="my-5">
              <li className="text-sm flex items-center gap-5">
                ...
                Access to past questions and relevant materials
              </li>
            ...
            <a href="https://chat.whatsapp.com/GMZrceHJFws1q4SFny4Adb">
              <button className="px-5 py-2 border border-gray-300 rounded-md text-sm success">
                JAMB CLASS
              </button>
            </a>

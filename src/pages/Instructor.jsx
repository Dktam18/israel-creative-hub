...
import { GiBirdHouse, GiCalendar, GiCalendarHalfYear, GiEvilBook, GiWorld } from "react-icons/gi"
      ...
      <div className='container'>
        ...
        <div className='content grid grid-cols-2 gap-5 md:grid-cols-1'>
          <div className='images rounded-lg relative overflow-hidden h-72 w-ful before:bg-backbg before:h-72 before:w-full before:absolute before:top-0 before:left-0 before:content before:z-10'>
            ...
            <div className='categ flex flex-col gap-4 absolute top-5 z-30 m-3 p-8 items-center justify-center text-center'>
              <h2 className='text-3xl text-white font-semibold'>Let us help you process your admission at the comfort of your home</h2>
              <button className='text-[15px] py-2 px-4 border border-gray-200 rounded-md text-white'>Get started</button>
            </div>
          </div>
          <div className='images rounded-lg relative overflow-hidden h-72 w-ful before:bg-backbg before:h-72 before:w-full before:absolute before:top-0 before:left-0 before:content before:z-10'>
            ...
            <div className='categ flex flex-col gap-4 absolute top-5 z-30 m-3 p-8 items-center justify-center text-center'>
              <h2 className='text-3xl text-white font-semibold'>Consult an expert/book a private class</h2>
              <button className='text-[15px] py-2 px-4 border border-gray-200 rounded-md text-white'>Book a session </button>
            </div>
          </div>
        </div>
        <div className='content'>
          ...
          <div className='content grid grid-cols-4 gap-5 md:grid-cols-2'>
            <InstructorCard color='text-red-500' icon={<FaUsers size={40} />} title='10,000' desc='Students Enrolled' />
            <InstructorCard color='text-orange-500' icon={<GiEvilBook size={40} />} title='N/A' desc='Total Courses' />
            <InstructorCard color='text-purple-500' icon={<FaGraduationCap size={40} />} title='10,000' desc='Online Learners' />
            <InstructorCard color='text-indigo-500' icon={<GiCalendar size={40} />} title='1 year' desc='of existence' />
          </div>
        </div>
      </div>
    </section>
